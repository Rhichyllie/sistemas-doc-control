...
function actionLabel(action: string) {
  const labels: Record<string, string> = {
    ...
    formal_revision_started: 'Nova revisão formal iniciada',
    formal_revision_submitted: 'Revisão formal enviada para aprovação',
    formal_revision_rejected: 'Correção solicitada na revisão formal',
    formal_revision_superseded: 'Revisão anterior superada',
    formal_revision_published: 'Nova revisão formal publicada',
    formal_revision_file_updated: 'Arquivo da revisão atualizado',
