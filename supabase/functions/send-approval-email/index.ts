...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // 5. Montar o link direto para o fluxo de aprovação
    const analysisLink = `${APP_BASE_URL}/authenticated/fluxo-de-aprovacao?documentId=${document.id}&stepId=${step.id}`;
